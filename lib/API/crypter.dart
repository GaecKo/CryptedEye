...
class Crypter {
  ...
  Future<Key> init(String password, String saltPath) async {
    ...
    if (_salt.isEmpty || _salt == []) {
      // if the file is empty or inexistant, we generate it
